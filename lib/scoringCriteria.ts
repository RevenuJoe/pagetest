...
- A LEAN, light navigation: logo on the left, ideally only 3 to 4 links in the middle. A bulky nav with 7+ links is a negative. CRITICAL: read the "Number of links inside <nav>: N" line in GROUND TRUTH. If N is 4 or fewer, the nav is NOT bulky — do NOT say "nav is bulky" or "navigation is bulky" or "slim the nav". 0 nav links is its own situation (the page lacks navigation entirely), not bulkiness.
