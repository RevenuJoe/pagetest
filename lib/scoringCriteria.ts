...
- Social proof visible above the fold — ideally you should see some form of it: customer logos, ratings ("4.9/5 on G2"), "Trusted by" copy, G2/Capterra/Trustpilot badges, customer counts ("Used by 10,000+ teams"), or named customer brands. Recognisable company logos (Google, Microsoft, AWS, Salesforce, hospital names, brand wordmarks etc.), star ratings, "Trusted by", "Used by", "Loved by", review badges, follower counts, press logos all qualify. BEFORE you flag social proof as missing, look at the above-the-fold screenshot CAREFULLY. If you can see even ONE of these elements in the above-the-fold viewport (desktop or mobile), the page HAS social proof above the fold — do NOT recommend adding it and do NOT say "social proof appears below the fold". When in doubt that an element is social proof, err on the side of treating it as present.
